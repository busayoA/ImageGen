...
class SpatialRegularizer(nn.Module):
    ...
    def transform_gradients(self, 
        ...
        """Transform gradients between camera views (simplified)"""
        # In full implementation, this would involve proper 3D transformation
        # Here we return a simple transformation for demonstration
        return gradients
    ...
    def transform_normals(self, 
        ...
        R_from = quaternion_to_matrix(pose_from.quaternion.unsqueeze(0))[0]
        R_to = quaternion_to_matrix(pose_to.quaternion.unsqueeze(0))[0]
