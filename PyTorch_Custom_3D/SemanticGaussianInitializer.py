...
class SemanticGaussianInitializer:
    ...
    def simple_structure_from_motion(self, 
                                   images: List[torch.Tensor], 
                                   poses: List[CameraPose]) -> Tuple[torch.Tensor, torch.Tensor]:
        """Simple SfM replacement - generates point cloud from camera poses and random sampling"""
    ...
    def initialize_gaussians(self, 
        ...
        points_3d, colors = self.simple_structure_from_motion(images, poses)
